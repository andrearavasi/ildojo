...
export default function WhatsappButton({ productName, price, productCode, limitato, esaurito }) {
...
È ancora disponibile? Grazie!`;
    ...
    return (
        ...
        >
            ...
            >
                {esaurito ? "Prodotto esaurito" : limitato ? "Richiedi info disponibilità" : "Acquista"}
            </a>
        </button>
    );
}